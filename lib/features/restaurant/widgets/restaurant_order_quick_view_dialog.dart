...
///  • « Encaisser » → ouvre DIRECTEMENT la caisse restaurant dédiée
///    ([RestaurantPosScreen], colonne de règlement) de cette commande ;
  ...
  List<Widget> actions(BuildContext ctx) => [
        Padding(
          ...
          child: Row(
            ...
            children: [
              // Aperçu photo du contenu de la commande.
              OrderDishThumbs(order: order, size: 44, radius: 8),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    OrderTypeBadge(type: order.type, compact: true),
                  ],
                ),
              ),
            ],
        ...
        if (order.status.isActive) ...[
          ...
          ListTile(
            ...
            subtitle: const Text('Caisse restaurant (règlement + ticket)'),
            onTap: order.isEmpty
                ? null
                : () {
                    Navigator.pop(ctx);
