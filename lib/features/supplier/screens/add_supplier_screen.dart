  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _isEditing
              ? localizations.editSupplierTitle
              : localizations.addSupplierTitle,
        ), // Localized
      ),
                ...
                children: [
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return localizations
                            .supplierNameValidationError; // Localized
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return localizations
                            .supplierPhoneValidationError; // Localized
                      }
                      return null;
                    },
                  ),
                    ...
                    validator: (value) {
                      if (value != null && value.isNotEmpty) {
                        ...
                        if (!emailRegex.hasMatch(value)) {
                          return localizations
                              .supplierEmailValidationError; // Localized
                        }
                      }
                      return null;
                    },
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          localizations.supplierContactPersonLabel, // Localized
                      border: const OutlineInputBorder(),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText:
                          localizations.supplierAddressLabel, // Localized
                      border: const OutlineInputBorder(),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        _isEditing
                            ? localizations.updateSupplierButton
                            : localizations.addSupplierButton,
                      ), // Localized
                    ),
                  ),
                ],
