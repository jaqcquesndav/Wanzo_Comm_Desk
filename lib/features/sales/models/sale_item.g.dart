...
SaleItem _$SaleItemFromJson(Map<String, dynamic> json) => SaleItem(
      ...
      unitPriceInCdf: (json['unitPriceInCdf'] as num?)?.toDouble() ?? 0.0,
      totalPriceInCdf: (json['totalPriceInCdf'] as num?)?.toDouble() ?? 0.0,
      itemType: $enumDecodeNullable(_$SaleItemTypeEnumMap, json['itemType']) ??
