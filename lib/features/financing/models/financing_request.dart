...
class FinancingRequest extends Equatable {
  ...
  @HiveField(
    36,
  ) // Source des données: TRANSACTION_HISTORY, BUSINESS_PROFILE, HYBRID
  final String? creditScoreDataSource;

  @HiveField(
    37,
  ) // Composants du score avec leurs poids (ex: {payment_history: 350, debt_ratio: 200, ...})
  ...
  FinancingRequest copyWith({
    ...
    return FinancingRequest(
      ...
      creditScoreCalculatedAt:
          creditScoreCalculatedAt ?? this.creditScoreCalculatedAt,
      creditScoreValidUntil:
          creditScoreValidUntil ?? this.creditScoreValidUntil,
      creditScoreModelVersion:
          creditScoreModelVersion ?? this.creditScoreModelVersion,
      riskLevel: riskLevel ?? this.riskLevel,
      confidenceScore: confidenceScore ?? this.confidenceScore,
      creditScoreDataSource:
          creditScoreDataSource ?? this.creditScoreDataSource,
      creditScoreComponents:
          creditScoreComponents ?? this.creditScoreComponents,
      creditScoreExplanation:
          creditScoreExplanation ?? this.creditScoreExplanation,
      creditScoreRecommendations:
          creditScoreRecommendations ?? this.creditScoreRecommendations,
    );
  }
    ...
    return FinancingRequest(
      ...
      approvalDate:
          json['approvalDate'] != null
              ...
              : null,
      disbursementDate:
          json['disbursementDate'] != null
              ? DateTime.parse(json['disbursementDate'] as String)
              : null,
      scheduledPayments:
          json['scheduledPayments'] != null
              ? (json['scheduledPayments'] as List)
                  .map((e) => DateTime.parse(e as String))
                  .toList()
              : null,
      completedPayments:
          json['completedPayments'] != null
              ? (json['completedPayments'] as List)
                  .map((e) => DateTime.parse(e as String))
                  .toList()
              : null,
      ...
      creditScoreCalculatedAt:
          json['creditScoreCalculatedAt'] != null
              ? DateTime.parse(json['creditScoreCalculatedAt'] as String)
              : null,
      creditScoreValidUntil:
          json['creditScoreValidUntil'] != null
      ...
      creditScoreComponents:
          json['creditScoreComponents'] != null
              ? Map<String, int>.from(json['creditScoreComponents'] as Map)
              : null,
      creditScoreExplanation:
          json['creditScoreExplanation'] != null
              ? (json['creditScoreExplanation'] as List)
                  .map((e) => e as String)
                  .toList()
              : null,
      creditScoreRecommendations:
          json['creditScoreRecommendations'] != null
              ? (json['creditScoreRecommendations'] as List)
                  .map((e) => e as String)
                  .toList()
              : null,
    );
  ...
  Map<String, dynamic> toJson() {
    ...
    if (completedPayments != null) {
      data['completedPayments'] =
          completedPayments!.map((date) => date.toIso8601String()).toList();
    }
    if (notes != null) {
      data['notes'] = notes;
    }
    ...
    if (creditScoreCalculatedAt != null) {
      data['creditScoreCalculatedAt'] =
          creditScoreCalculatedAt!.toIso8601String();
    }
